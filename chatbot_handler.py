...
def generate_ari_speech():
    ...
    num_sentences = max(1, int(round(np.random.normal(1, 2, 5)[0], 0)))
    ...
    for i in range(num_sentences):
        ...
        sentence = chosen_text_model.make_short_sentence(max_chars=ARI_TEXT_AVERAGE_LENGTH*2, min_chars=ARI_TEXT_AVERAGE_LENGTH/2, tries=1000)
